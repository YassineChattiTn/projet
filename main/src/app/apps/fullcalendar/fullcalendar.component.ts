...
export class FullcalendarComponent {
    ...
    constructor(public dialog: MatDialog, @Inject(DOCUMENT) doc: any, private _calendar:CalendarService) { }
    ...
    addEvent(): void {
        ...
        this.dialogRef2.afterClosed().subscribe((res) => {
          ...
          const responseEvent: EgretCalendarEvent = res.event;
    ...
    createEvent(event: EgretCalendarEvent): void { 
        this._calendar.createEv(event).subscribe(
            
          (res) => {
            console.log('Event created successfully in the backend!', res);
          },
          (err) => {
